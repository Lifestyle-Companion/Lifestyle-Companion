...
const APP = window.HEC_APP || {name:"Healthy Eating Companion",version:"0.6.8",storageKey:"healthyEatingCompanionAlpha06",functionalStorageKey:"healthyEatingCompanionAlpha06Functional"};
...
const FOODS = [
  ...
  ,{id:"carrot-cake",name:"Carrot Cake",brand:"Generic Australian",category:"Bakery",country:"Australia",aliases:["carrot cake","slice of carrot cake"],defaultAmount:1,defaultUnit:"slice",units:{slice:1,g:1/90},unitLabels:{slice:"slice (about 90 g)",g:"g"},serving:"1 slice (90 g)",nutrients:nutrient(330,4,45,15,5,2,28,260),score:4,source:"Australian Generic Estimate — Verify Brand Or Recipe",verified:false,ingredients:"Carrot cake with icing; recipe varies",allergens:["wheat","egg","milk"]},
  {id:"white-bread",name:"White Sandwich Bread",brand:"Generic Australian",category:"Bakery",country:"Australia",aliases:["white bread","sandwich bread","toast"],defaultAmount:1,defaultUnit:"slice",units:{slice:1,g:1/35},unitLabels:{slice:"slice (35 g)",g:"g"},serving:"1 slice",nutrients:nutrient(90,3,17,1,.2,1,2,170),score:6,source:"Australian Generic Estimate",verified:false,ingredients:"Wheat flour, water, yeast, salt",allergens:["wheat"]},
  {id:"bacon-rashers",name:"Bacon Rashers, Pan-Fried",brand:"Generic Australian",category:"Meat & Seafood",country:"Australia",aliases:["bacon","bacon rasher","rashers"],defaultAmount:2,defaultUnit:"rasher",units:{rasher:.5,g:1/50,serving:1},unitLabels:{rasher:"rasher",g:"g",serving:"2 rashers"},serving:"2 rashers (50 g)",nutrients:nutrient(190,15,1,14,5,0,1,700),score:4,source:"Australian Generic Estimate",verified:false,ingredients:"Cured pork",allergens:[]},
  {id:"cheddar-cheese",name:"Tasty Cheddar Cheese",brand:"Generic Australian",category:"Dairy & Eggs",country:"Australia",aliases:["tasty cheese","cheddar","cheese slice","cheese"],defaultAmount:25,defaultUnit:"g",units:{g:1/25,slice:1,serving:1},unitLabels:{g:"g",slice:"slice (25 g)",serving:"25 g serve"},serving:"25 g",nutrients:nutrient(103,6.3,.3,8.5,5.5,0,.1,155),score:5,source:"Australian Generic Estimate",verified:false,ingredients:"Milk, salt, cultures, enzyme",allergens:["milk"]},
  {id:"ham-sliced",name:"Sliced Leg Ham",brand:"Generic Australian",category:"Meat & Seafood",country:"Australia",aliases:["ham","leg ham","sliced ham"],defaultAmount:2,defaultUnit:"slice",units:{slice:.5,g:1/50,serving:1},unitLabels:{slice:"regular slice",g:"g",serving:"2 slices (50 g)"},serving:"50 g",nutrients:nutrient(75,10,1.5,3,1,0,1,620),score:5,source:"Australian Generic Estimate",verified:false,ingredients:"Pork, water, salt, curing ingredients",allergens:[]},
  {id:"beef-mince",name:"Lean Beef Mince, Cooked",brand:"Fresh",category:"Meat & Seafood",country:"Australia",aliases:["beef mince","mince","ground beef"],defaultAmount:100,defaultUnit:"g",units:{g:.01,serving:1},unitLabels:{g:"g",serving:"100 g serve"},serving:"100 g",nutrients:nutrient(215,26,0,12,5,0,0,75),score:7,source:"Australian Generic Estimate",verified:false,ingredients:"Beef",allergens:[]},
  {id:"sausages-beef",name:"Beef Sausage, Cooked",brand:"Generic Australian",category:"Meat & Seafood",country:"Australia",aliases:["sausage","beef sausage","snag"],defaultAmount:1,defaultUnit:"item",units:{item:1,g:1/75},unitLabels:{item:"medium sausage",g:"g"},serving:"1 sausage (75 g)",nutrients:nutrient(210,11,5,16,6,0,1,590),score:4,source:"Australian Generic Estimate",verified:false,ingredients:"Beef, cereal, seasoning; varies",allergens:["wheat"]},
  {id:"chicken-drumstick",name:"Chicken Drumstick, Roasted",brand:"Fresh",category:"Meat & Seafood",country:"Australia",aliases:["chicken drumstick","drumsticks"],defaultAmount:1,defaultUnit:"item",units:{item:1,g:1/85},unitLabels:{item:"medium drumstick",g:"g"},serving:"1 drumstick",nutrients:nutrient(155,20,0,8,2.2,0,0,85),score:7,source:"Australian Generic Estimate",verified:false,ingredients:"Chicken",allergens:[]},
  {id:"pasta-cooked",name:"Pasta, Cooked",brand:"Generic",category:"Pantry",country:"Australia",aliases:["pasta","spaghetti","macaroni"],defaultAmount:150,defaultUnit:"g",units:{g:1/150,cup:1,serving:1},unitLabels:{g:"g",cup:"cup",serving:"150 g serve"},serving:"150 g",nutrients:nutrient(235,8,46,1.5,.3,3,1,5),score:7,source:"Australian Generic Estimate",verified:false,ingredients:"Durum wheat semolina, water",allergens:["wheat"]},
  {id:"corn-thins",name:"Corn Thins",brand:"Generic",category:"Snacks",country:"Australia",aliases:["corn thins","corn cakes","rice cakes"],defaultAmount:4,defaultUnit:"slice",units:{slice:.25,g:1/26,serving:1},unitLabels:{slice:"thin",g:"g",serving:"4 thins"},serving:"4 thins",nutrients:nutrient(110,2,23,1,.2,1,1,110),score:6,source:"Australian Generic Estimate",verified:false,ingredients:"Corn",allergens:[]},
  {id:"pepsi-max",name:"Cola, Diet Or Zero",brand:"Generic",category:"Drinks",country:"Australia",aliases:["pepsi max","coke zero","diet coke","zero soft drink"],defaultAmount:375,defaultUnit:"mL",units:{mL:1/375,can:1},unitLabels:{mL:"mL",can:"can (375 mL)"},serving:"375 mL",nutrients:nutrient(2,0,0,0,0,0,0,20),score:5,source:"Generic Label Estimate",verified:false,ingredients:"Carbonated water, sweeteners, flavour",allergens:[]},
  {id:"orange-juice",name:"Orange Juice",brand:"Generic",category:"Drinks",country:"Australia",aliases:["orange juice","fruit juice","juice"],defaultAmount:250,defaultUnit:"mL",units:{mL:1/250,glass:1},unitLabels:{mL:"mL",glass:"glass (250 mL)"},serving:"250 mL",nutrients:nutrient(110,2,25,.5,.1,.5,21,5),score:5,source:"Australian Generic Estimate",verified:false,ingredients:"Orange juice",allergens:[]},
  {id:"regular-cola",name:"Cola Soft Drink, Regular",brand:"Generic",category:"Drinks",country:"Australia",aliases:["cola","coke","pepsi","soft drink"],defaultAmount:375,defaultUnit:"mL",units:{mL:1/375,can:1},unitLabels:{mL:"mL",can:"can (375 mL)"},serving:"375 mL",nutrients:nutrient(161,0,40,0,0,0,40,38),score:2,source:"Generic Label Estimate",verified:false,ingredients:"Carbonated water, sugar, colour, flavour",allergens:[]},
  {id:"tea-black",name:"Tea Or Coffee, No Milk Or Sugar",brand:"Generic",category:"Drinks",country:"Australia",aliases:["tea","black tea","black coffee","coffee no milk"],defaultAmount:250,defaultUnit:"mL",units:{mL:1/250,cup:1},unitLabels:{mL:"mL",cup:"cup (250 mL)"},serving:"250 mL",nutrients:nutrient(2,0,0,0,0,0,0,5),score:9,source:"Generic Estimate",verified:false,ingredients:"Water and brewed tea or coffee",allergens:[]},
  {id:"cottage-cheese",name:"Cottage Cheese",brand:"Generic Australian",category:"Dairy & Eggs",country:"Australia",aliases:["cottage cheese"],defaultAmount:100,defaultUnit:"g",units:{g:.01,serving:1},unitLabels:{g:"g",serving:"100 g serve"},serving:"100 g",nutrients:nutrient(98,12,3.4,4.3,1.7,0,2.7,360),score:8,source:"Australian Generic Estimate",verified:false,ingredients:"Milk, cultures, salt",allergens:["milk"]},
  {id:"omelette",name:"Omelette, Plain",brand:"Homemade Estimate",category:"Dairy & Eggs",country:"Australia",aliases:["omelette","omelet"],defaultAmount:1,defaultUnit:"serving",units:{serving:1,g:1/120},unitLabels:{serving:"2-egg omelette",g:"g"},serving:"1 omelette",nutrients:nutrient(190,13,2,14,5,0,1,220),score:7,source:"Homemade Estimate — Ingredients Vary",verified:false,ingredients:"Eggs and small amount of cooking fat",allergens:["egg"]},
  {id:"scrambled-eggs",name:"Scrambled Eggs, Plain",brand:"Homemade Estimate",category:"Dairy & Eggs",country:"Australia",aliases:["scrambled egg","scrambled eggs"],defaultAmount:1,defaultUnit:"serving",units:{serving:1,g:1/120},unitLabels:{serving:"2-egg serve",g:"g"},serving:"1 serve",nutrients:nutrient(190,13,2,14,5,0,1,220),score:7,source:"Homemade Estimate — Ingredients Vary",verified:false,ingredients:"Eggs and small amount of cooking fat",allergens:["egg"]},
  {id:"baked-beans",name:"Baked Beans In Tomato Sauce",brand:"Generic Australian",category:"Pantry",country:"Australia",aliases:["baked beans","beans on toast"],defaultAmount:130,defaultUnit:"g",units:{g:1/130,serving:1,can:3.2},unitLabels:{g:"g",serving:"130 g serve",can:"420 g can"},serving:"130 g",nutrients:nutrient(105,6,18,.5,.1,5,5,420),score:8,source:"Australian Generic Estimate",verified:false,ingredients:"Beans, tomato sauce",allergens:[]},
  {id:"mashed-potato",name:"Mashed Potato With Milk",brand:"Homemade Estimate",category:"Fruit & Vegetables",country:"Australia",aliases:["mashed potato","mash"],defaultAmount:150,defaultUnit:"g",units:{g:1/150,serving:1},unitLabels:{g:"g",serving:"150 g serve"},serving:"150 g",nutrients:nutrient(170,4,28,5,3,3,2,180),score:6,source:"Homemade Estimate",verified:false,ingredients:"Potato, milk and fat; recipe varies",allergens:["milk"]}
];
...
// Alpha 0.6.8: keep a plain egg separate from egg dishes so search and preparation are easier to understand.
FOODS.push(
...
const MEAL_SUGGESTIONS = [
  ...
  {id:"suggest-morning-light",name:"Small Berry Snack",meal:"Morning Tea",score:9,reason:"A very light fruit option for a tightly budgeted day.",items:[{foodId:"berries",amount:80,unit:"g"}]},
  ...
  {id:"suggest-afternoon-light",name:"Small Plain Yoghurt",meal:"Afternoon Tea",score:8,reason:"A small dairy-and-protein option for a lower-energy day.",items:[{foodId:"greek-yoghurt",amount:60,unit:"g"}]},
  ...
  {id:"suggest-morning-egg",name:"Boiled Egg",meal:"Morning Tea",score:8,reason:"A compact protein snack when fruit is already well covered.",items:[{foodId:"egg",amount:1,unit:"item"}]},
  {id:"suggest-morning-yoghurt",name:"Small Yoghurt",meal:"Morning Tea",score:8,reason:"A modest dairy and protein snack.",items:[{foodId:"greek-yoghurt",amount:100,unit:"g"}]},
  ...
  {id:"suggest-afternoon-egg",name:"Egg & Apple",meal:"Afternoon Tea",score:8,reason:"A compact protein and fruit snack.",items:[{foodId:"egg",amount:1,unit:"item"},{foodId:"apple",amount:1,unit:"item"}]},
  {id:"suggest-afternoon-toast",name:"Wholemeal Toast & Avocado",meal:"Afternoon Tea",score:8,reason:"A savoury snack that contributes grains and healthy fats.",items:[{foodId:"wholemeal-bread",amount:1,unit:"slice"},{foodId:"avocado",amount:30,unit:"g"}]},
...
const EXT_DEFAULTS = {
  version:"0.6.8", diary:{}, daySettings:{}, water:{}, fluidTargets:{}, steps:{}, dailyNotes:{}, exercise:[], shopping:[], onlineFoods:[], onlineSearchCache:{},
...
function loadExt(){
  ...
  if(current){ const loaded=merge(clone(EXT_DEFAULTS),current); loaded.version="0.6.8"; return loaded; }
  for(const legacyKey of LEGACY_EXT_KEYS){
    try {
      const legacy = JSON.parse(localStorage.getItem(legacyKey));
      if(legacy){
        const migrated = merge(clone(EXT_DEFAULTS),legacy);
        migrated.version = "0.6.8";
...
function convertAfcdFood(raw){
  ...
  return {id:raw.id,afcdKey:raw.afcdKey,name:raw.name,brand:"Australian Food Composition Database",category:afcdCategory(raw),country:"Australia",aliases:[],defaultAmount:liquid&&gravity>0?100:100,defaultUnit:liquid&&gravity>0?"mL":"g",units,unitLabels:labels,serving:"Reference Values per 100 g",nutrients:raw.nutrients,score:7,source:"Food Standards Australia New Zealand · AFCD Release 3",verified:true,ingredients:raw.description||"",allergens:[],waterMl:n(raw.moisture),foodGroups:afcdFoodGroups(raw),afcd:true,derivation:raw.derivation||""};
}
...
function currentGoals(date=isoToday()){
  ...
  const exerciseCredit=(ext.exercise||[]).filter(x=>x.date?.slice(0,10)===date).reduce((sum,x)=>sum+n(x.credit),0),hydration=hydrationReference(),macros=balancedMacroTargets(calTarget||300);
...
function renderDiary(){
  ...
  by("day-settings-note").textContent=!baseTarget&&type==="normal"?"Your profile recommendation could not be recovered. Open Edit Health Profile and calculate your recommendations before saving this day.":type==="fasting"?"Fasting Day. The companion plans only the meal occasions you select and keeps the projected day within your fasting target.":"Normal Day. Your current accepted profile recommendation is used unless you deliberately choose a different target for this date.";
  const goals=currentGoals(date),summary=daySummary(date),consumed=summary.nutrients.calories,plannedCal=summary.planned.calories,projected=consumed+plannedCal,remaining=Math.max(0,(summary.goals.calories||0)-projected);
  ...
  if(by("diary-day-plan-summary"))by("diary-day-plan-summary").textContent=`${formatNumber(consumed)} Cal Eaten · ${formatNumber(plannedCal)} Cal Planned · ${formatNumber(projected)} Cal Projected${goals.calories?` · ${formatNumber(remaining)} Cal Available`:""}`;
  by("diary-day-summary").innerHTML=`<article class="summary-slide"><span>${date===isoToday()?"Today’s Energy":relativeDateLabel(date).split(" · ")[0]+" Energy"}</span><div class="diary-kpi-row"><div><small>Goal</small><strong>${goals.calories?`${formatNumber(goals.calories)} Cal`:"Needs Review"}</strong></div><div><small>Projected</small><strong>${formatNumber(projected)} Cal</strong></div><div><small>Available</small><strong>${goals.calories?`${formatNumber(remaining)} Cal`:"—"}</strong></div></div></article><article class="summary-slide"><span>Macronutrients Eaten</span><div class="diary-kpi-row"><div><small>Protein</small><strong>${formatNumber(summary.nutrients.protein)} g</strong></div><div><small>Fat</small><strong>${formatNumber(summary.nutrients.fat)} g</strong></div><div><small>Carbs</small><strong>${formatNumber(summary.nutrients.carbs)} g</strong></div></div></article><article class="summary-slide"><span>Five Food Groups Eaten</span><div class="mini-food-groups">${FOOD_GROUP_KEYS.map(key=>`<div><small>${esc(FOOD_GROUP_LABELS[key])}</small><strong>${formatNumber(summary.foodGroups[key],true)}/${formatNumber(summary.goals.foodGroups[key],true)}</strong></div>`).join("")}</div></article>`;
  const diagnostics=calculationDiagnostics(date),diagnosticBox=by("diary-calculation-status");diagnosticBox.className=`calculation-status compact-diary-status ${diagnostics.missing.length?"warning":"neutral"}`;diagnosticBox.innerHTML=diagnostics.missing.length?`<strong>Check ${diagnostics.missing.length} ${diagnostics.missing.length===1?"Entry":"Entries"}</strong><span>Energy is unavailable, so the day total may be incomplete.</span>`:`<strong>${formatNumber(projected)} Cal Projected</strong><span>${formatNumber(consumed)} Eaten · ${formatNumber(plannedCal)} still Planned</span>`;
  const entries=entriesForDate(date),view="all";ext.ui.diaryView="all";
  by("diary-meals").innerHTML=mealNames().map(meal=>{const allMealEntries=entries.filter(e=>e.meal===meal&&e.status!=="skipped"),totals=sumNutrients(allMealEntries);return `<section class="meal-list-section redesigned-meal-section" data-meal-name="${esc(meal)}"><header class="meal-list-heading redesigned-meal-heading"><div><h3>${esc(meal)}</h3><strong>${formatNumber(totals.calories)} Cal</strong></div><small>${allMealEntries.length?`${allMealEntries.length} ${allMealEntries.length===1?"Entry":"Entries"}`:"No Entries Yet"}</small></header><div class="meal-simple-list">${allMealEntries.length?allMealEntries.map(entryCard).join(""):`<p class="meal-empty">No Entries Yet.</p>`}</div><footer class="meal-list-actions redesigned-meal-actions"><button class="meal-add-text" data-add-to-meal="${esc(meal)}">＋ Add Food</button><button class="meal-suggest-text" data-suggest-context-meal="${esc(meal)}">✨ Suggest</button><button class="meal-more-text" data-meal-menu="${esc(meal)}">•••</button></footer><div class="meal-menu-actions hidden" data-meal-actions="${esc(meal)}">${allMealEntries.length?`<button data-save-meal-template="${esc(meal)}">Save As Reusable Meal</button><button data-clear-diary-meal="${esc(meal)}" class="delete-action">Clear ${esc(meal)}</button>`:`<span>No Additional Meal Actions Yet.</span>`}</div></section>`;}).join("");
  if(ext.ui.focusMeal){setTimeout(()=>{q(`[data-meal-name="${CSS.escape(ext.ui.focusMeal)}"]`)?.scrollIntoView({block:"start",behavior:"smooth"});ext.ui.focusMeal="";saveExt();},60);}
  saveExt();
}
function entryCard(entry){return `<article class="simple-diary-entry" data-entry-id="${esc(entry.id)}"><button class="entry-open" data-entry-edit="${esc(entry.id)}"><span><strong>${esc(entry.name)}</strong><small>${formatNumber(entry.amount,true)} ${esc(entry.unitLabel||entry.unit)}</small></span><b>${formatNumber(entry.nutrients?.calories)} Cal</b></button><button class="entry-more" data-entry-menu="${esc(entry.id)}">•••</button><div class="entry-inline-actions hidden" data-entry-actions="${esc(entry.id)}"><button data-entry-copy="${esc(entry.id)}">Copy</button><button data-entry-delete="${esc(entry.id)}" class="delete-action">Delete Food</button></div></article>`;}
...
function prepareEntry(food,{entry=null,date=null,meal=null,status="eaten",source=null}={}){
  ...
  by("entry-editor-title").textContent=entry?`Edit ${entry.name}`:`Review ${food.name}`;by("entry-date").value=entry?.date||defaultDate;by("entry-meal").value=entry?.meal||meal||ext.ui.pendingMeal||"Breakfast";by("entry-status").value="eaten";by("entry-time").value=entry?.time||localClock();by("entry-notes").value=entry?.notes||"";
...
function saveEditorEntry(andSaveFood=false){
  ...
  const record = {
    id:editorState.entryId || uid("entry"),foodId:baseFood.id,name:food.name,brand:food.brand || "",date,meal:by("entry-meal").value,status:"eaten",
...
function saveDaySettings(showMessage=true){
  ...
  ext.daySettings[date]={type,targetCal,customTarget};if(type==="fasting"&&!customTarget)ext.dayTypeTargets.fasting=targetCal;saveExt();daySettingsBaseline=clone(ext.daySettings[date]);setDaySettingsDirty(false);if(by("day-settings-details"))by("day-settings-details").open=false;renderDiary();if(showMessage)showActionToast("Day Settings Saved.",null,5000);
}
...
function saveMealTemplatePrompt(meal){
  ...
  openModal("Save This Meal",`Save these ${entries.length} ${entries.length===1?"item":"items"} as a reusable meal.`,`Save Meal`,() => {
    ...
    ext.mealTemplates.push({id:uid("meal"),name,items:entries.map(e=>({...clone(e),id:undefined,date:undefined,status:"eaten"})),createdAt:new Date().toISOString()});saveExt();showActionToast(`${name} saved to Saved Meals.`,null,6000);
...
function renderLibrary(){
  ...
  const libraryFoods=tab==="saved"?allFoods().filter(food=>ext.savedFoodIds.includes(food.id)):(tab==="all"?localFoods:localFoods).filter(food=>food.category!=="Recipe");const ranked=libraryFoods.filter(food=>tab==="custom"?food.source==="User Created":true).map(food=>({food,rank:searchRank(food,query)})).filter(item=>item.rank>0).sort((a,b)=>b.rank-a.rank||Number(b.food.country==="Australia")-Number(a.food.country==="Australia")||a.food.name.localeCompare(b.food.name));const strongMatch=ranked.some(item=>item.rank>=760);let visible=query?ranked.filter(item=>item.rank>=(strongMatch?760:620)):ranked;if(!query&&tab==="all")visible=visible.filter(item=>!item.food.afcd).slice(0,80);let closeNote="";if(query&&visible.length){const best=visible[0];if(normalise(best.food.name)!==normalise(query)&&best.rank>=620)closeNote=`<div class="search-guidance compact-search-guidance"><strong>Showing results for ${esc(best.food.name)}</strong><small>Your search was “${esc(query)}”.</small></div>`;}by("food-results").innerHTML=visible.length?`${closeNote}${visible.map(item=>resourceFoodRow(item.food)).join("")}`:`<div class="resource-empty"><strong>No Close Match Found.</strong><p>Try fewer words or create a private food entry.</p></div>`;renderRecipeSelectOptions();renderScanSelect();
}
...
function showSingleMealSuggestion(meal,prefs={},retry=false){
  ...
  openModal(`Companion Suggestion for ${meal}`,"Review the suggestion before adding it. Nothing is added until you confirm.","Add to Plan",()=>{acceptPlannedSuggestion(meal);setTimeout(()=>{if(q("#food-diary.active"))renderDiary();},50);},extra);
...
function addMealTemplate(id){
  ...
  openModal(`Add ${template.name}?`,`This creates independent planned entries on ${formatDate(date)}.`,"Add to Plan",()=>{
    ext.diary[date] ||= [];
    template.items.forEach(item=>ext.diary[date].push({...clone(item),id:uid("entry"),date,meal,status:"eaten",localDate:date,timeZone:activeTimeZone(),createdAt:new Date().toISOString()}));saveExt();openFeature("food-diary");showActionToast(`${template.name} added to the Diary.`,null,6000);
  });
}
...
by("confirm-voice-log")?.addEventListener("click",()=>{
  if(!voiceParsed.items?.length)return;const date=by("voice-date").value||isoToday(),meal=by("voice-meal").value;if(!meal){showActionToast("Choose a meal before adding this food.",null,5000);return;}ext.diary[date] ||= [];
...
by("photo-add-note")?.addEventListener("click",()=>showActionToast("Meal photos are kept only during this browser session in Alpha 0.6.8. Add a written Diary note for lasting context.",null,8000));
...
function plannerProjectedState(date,excludeMeal=""){
  let nutrients=dayNutrition(date,["eaten","planned"]),groups=dayFoodGroups(date,["eaten","planned"]);
...
function plannerBudget(){
  const date=ext.ui.plannerDate||isoToday(),selected=selectedPlannerMeals(),goals=currentGoals(date),goal=goals.calories,entries=entriesForDate(date).filter(e=>e.status==="eaten"||e.status==="planned"),fixed=entries.reduce((sum,e)=>sum+n(e.nutrients?.calories),0),type=goals.dayType||"normal";
  ...
  if(selected.length===1&&prefs.meal===selected[0]&&desired.length){
    ...
    if(type==="fasting"){
      ...
      const decide={Breakfast:.42,"Morning Tea":.22,Lunch:.50,"Afternoon Tea":.22,Dinner:.62,Snacks:.22}[selected[0]]||.45;
...
function renderPlannerEnergySummary(){const box=by("planner-energy-summary");if(!box)return;const b=plannerBudget(),meals=selectedPlannerMeals(),mode=by("planner-day-mode-note");if(mode)mode.textContent=b.type==="fasting"?"Fasting Day: unticked meal categories are treated as meals you intend to skip. The remaining fasting allowance is divided only across the meals you select.":"Normal Day: the planner keeps a sensible reserve for unticked meals, unless you have already added food there.";box.innerHTML=meals.length?`<span class="eyebrow">Energy Available for Companion Planning</span><strong>${formatNumber(b.available)} Cal</strong><small>Daily goal ${formatNumber(b.goal)} Cal · ${formatNumber(b.fixed)} Cal already eaten or planned${b.reserve?` · ${formatNumber(b.reserve)} Cal kept in reserve for unticked meals`:""}</small><div class="planner-guide-list">${meals.map(m=>`<span>${esc(m)} <b>about ${formatNumber(b.guides[m])} Cal more</b>${b.existingByMeal[m]?` <small>(${formatNumber(b.existingByMeal[m])} Cal already in this meal)</small>`:""}</span>`).join("")}</div>`:`<span class="eyebrow">Start a New Plan</span><strong>Select one or more meals</strong><small>The companion will account for everything already Eaten or Planned before making suggestions.</small>`;}
...
function plannerChoice(meal,retry=false){
  const min=n(by("planner-min-score")?.value),budget=plannerBudget(),target=budget.guides[meal]??0,current=ext.ui.plannerResults?.[meal],rejected=ext.ui.plannerRejected?.[meal]||[],hardCap=plannerHardCapForMeal(meal);let candidates=MEAL_SUGGESTIONS.filter(s=>s.meal===meal&&s.score>=min&&!suggestionSafety(s).length);
...
function addPlannedSuggestion(meal,mode="add"){
  const suggestion=MEAL_SUGGESTIONS.find(s=>s.id===ext.ui.plannerResults?.[meal]);if(!suggestion)return;const date=ext.ui.plannerDate||by("planner-date")?.value||isoToday();ext.diary[date]||=[];const uniqueRef=`${date}|${meal}|${suggestion.id}`;if(ext.diary[date].some(e=>e.plannerRef===uniqueRef)){ext.ui.plannerAccepted[meal]=suggestion.id;saveExt();renderMealSuggestions();showActionToast(`${suggestion.name} is already in the plan.`,null,6000);return;}if(mode==="replace")ext.diary[date]=ext.diary[date].filter(e=>!(e.meal===meal&&e.status==="planned"));suggestion.items.forEach(i=>{const f=getFood(i.foodId);ext.diary[date].push({id:uid("entry"),foodId:f.id,name:f.name,brand:f.brand,date,meal,status:"eaten",amount:i.amount,unit:i.unit,unitLabel:unitLabel(f,i.unit),time:"",notes:`Meal Planner · ${suggestion.name}`,nutrients:scaledNutrients(f,i.amount,i.unit),foodGroups:scaledFoodGroups(f,i.amount,i.unit),waterMl:scaledWaterMl(f,i.amount,i.unit),hydrationType:f.hydrationType||"food",score:f.score,source:`Meal Planner · ${f.source}`,plannerRef:uniqueRef,localDate:date,timeZone:activeTimeZone(),createdAt:new Date().toISOString()});});ext.ui.diaryDate=date;ext.ui.progressDate=date;ext.ui.plannerAccepted[meal]=suggestion.id;saveExt();renderMealSuggestions();renderPlannerEnergySummary();if(q("#food-diary.active"))renderDiary();showActionToast(`${suggestion.name} added to ${meal} .`,()=>{ext.diary[date]=ext.diary[date].filter(e=>e.plannerRef!==uniqueRef);delete ext.ui.plannerAccepted[meal];saveExt();renderMealSuggestions();renderPlannerEnergySummary();if(q("#food-diary.active"))renderDiary();},9000);
}
function acceptPlannedSuggestion(meal){const date=ext.ui.plannerDate||by("planner-date")?.value||isoToday(),existing=entriesForDate(date).filter(e=>e.meal===meal&&e.status!=="skipped");if(!existing.length){addPlannedSuggestion(meal);return;}openModal(`${meal} already has entries`,`The companion has calculated around what you already planned. Choose whether to add the suggestion alongside those entries or replace only existing Planned items. Eaten entries are never removed.`,`Add Alongside Existing`,()=>addPlannedSuggestion(meal,"add"),`<button id="replace-planned-meal" class="secondary wide" type="button">Replace Existing Planned Items</button>`);by("replace-planned-meal")?.addEventListener("click",()=>{closeModal();addPlannedSuggestion(meal,"replace");},{once:true});}
by("planner-select-all")?.addEventListener("change",event=>{qa('input[name="planner-meal"]').forEach(x=>x.checked=event.target.checked);updatePlannerSelectAll();});qa('input[name="planner-meal"]').forEach(input=>input.addEventListener("change",()=>{clearPlannerResults();updatePlannerSelectAll();}));by("planner-min-score")?.addEventListener("change",()=>{clearPlannerResults();renderPlannerEnergySummary();});by("generate-meal-suggestions")?.addEventListener("click",()=>generatePlannerResults(false));by("try-all-meal-suggestions")?.addEventListener("click",()=>generatePlannerResults(true));document.addEventListener("click",event=>{const retry=event.target.closest("[data-plan-retry]");if(retry){plannerChoice(retry.dataset.planRetry,true);saveExt();renderMealSuggestions();return;}const accept=event.target.closest("[data-plan-accept]");if(accept){acceptPlannedSuggestion(accept.dataset.planAccept);return;}const more=event.target.closest("#planner-plan-more");if(more){resetPlannerSelections();saveExt();renderMealSuggestions();renderPlannerEnergySummary();window.scrollTo({top:0,behavior:"smooth"});return;}const undo=event.target.closest("[data-plan-undo]");if(undo){const meal=undo.dataset.planUndo,date=ext.ui.plannerDate||isoToday(),id=ext.ui.plannerAccepted?.[meal];ext.diary[date]=(ext.diary[date]||[]).filter(e=>!(e.meal===meal&&e.plannerRef?.endsWith(`|${id}`)));delete ext.ui.plannerAccepted[meal];saveExt();renderMealSuggestions();renderPlannerEnergySummary();showActionToast(`${meal} suggestion removed from the plan.`,null,5000);}});
...
by("print-shopping-list")?.addEventListener("click",()=>{renderShoppingPrint();document.body.classList.add("printing-shopping");setTimeout(()=>{window.print();document.body.classList.remove("printing-shopping");},80);});by("share-shopping-list")?.addEventListener("click",async()=>{const text=shoppingShareText();if(navigator.share)try{await navigator.share({title:"Shopping List",text});}catch{}else{await navigator.clipboard?.writeText(text);showActionToast("Shopping list copied to the clipboard.",null,5000);}});
...
function renderHistory(period){
  ...
  by("history-summary").innerHTML=`<strong>Food Diary Days: ${recorded.length} · Weight Check-Ins: ${weights.length} · Activities: ${activities.length} ${activities.length===1?"Activity":"Activities"}</strong><p>Averages use recorded days only. Missing days are not counted as zero food intake.</p>`;
  const values=weights.map(x=>n(x.weightKg));const rawMin=values.length?Math.min(...values):0,rawMax=values.length?Math.max(...values):1,min=rawMin-0.5,max=rawMax+0.5,span=Math.max(1,max-min);
  by("history-bars").innerHTML=weights.length?weights.map(x=>`<div class="history-column"><i style="height:${35+(n(x.weightKg)-min)/span*145}px"></i><small>${formatNumber(x.weightKg,true)} kg<br>${esc(formatDate(x.date).replace(/ \d{4}$/,""))}</small></div>`).join(""):`<p class="empty-state">Add weight check-ins to build your weight trend.</p>`;
...
by("download-data")?.addEventListener("click",()=>{const blob=new Blob([JSON.stringify({profile:mainData(),functional:ext},null,2)],{type:"application/json"}),url=URL.createObjectURL(blob),a=document.createElement("a");a.href=url;a.download=`healthy-eating-companion-alpha-0-6-7-data-${isoToday()}.json`;a.click();URL.revokeObjectURL(url);});

// Contextual help
const HELP={
  "food-diary":"The Diary is the main place to build your day. Add food directly inside a meal, or tap Suggest to ask the companion for that meal. Future and planning entries are Planned automatically; use Ate  when the meal happened as expected. Edit Day opens Normal/Fasting settings only when you need them. Plan Multiple Meals opens the separate bulk planner.",
  ...
  "meal-planner":"Use this screen for bulk planning several meals. For a single Breakfast, Lunch, Dinner or snack suggestion, use Suggest directly inside the Diary. Existing Eaten and Planned foods are always accounted for before new suggestions are calculated.",
...
// Alpha 0.6.8 migration: keep existing records, repair the stale Normal-Day target, and preserve explicit per-date overrides only when marked custom.
function refreshDiaryEnergyPreview(target){const slide=by("diary-day-summary")?.querySelector(".summary-slide");if(!slide)return;const date=diaryDate(),consumed=dayNutrition(date,["eaten"]).calories,planned=dayNutrition(date,["planned"]).calories,exercise=(ext.exercise||[]).filter(x=>x.date?.slice(0,10)===date).reduce((sum,x)=>sum+n(x.credit),0),goal=n(target)?n(target)+exercise:0,projected=consumed+planned;slide.innerHTML=`<span>${date===isoToday()?"Today’s Energy":relativeDateLabel(date).split(" · ")[0]+" Energy"}</span><div class="diary-kpi-row"><div><small>Goal</small><strong>${goal?`${formatNumber(goal)} Cal`:"Needs Review"}</strong></div><div><small>Projected</small><strong>${formatNumber(projected)} Cal</strong></div><div><small>Available</small><strong>${goal?`${formatNumber(Math.max(0,goal-projected))} Cal`:"—"}</strong></div></div>`;}
ext.version="0.6.8";ext.dayTypeTargets||={fasting:500};if(!n(ext.dayTypeTargets.fasting))ext.dayTypeTargets.fasting=500;const recoveredNormal=recommendedNormalTarget();if(recoveredNormal){ext.dayTypeTargets.normal=recoveredNormal;ext.dayTypeTargets.normalSource="profile";}else if(ext.dayTypeTargets.normalSource!=="profile"){delete ext.dayTypeTargets.normal;delete ext.dayTypeTargets.normalSource;}Object.values(ext.daySettings||{}).forEach(settings=>{if(!settings)return;if(settings.type==="normal"&&!settings.customTarget){if(recoveredNormal)settings.targetCal=recoveredNormal;else delete settings.targetCal;}if(settings.customTarget===undefined)settings.customTarget=false;});normaliseShoppingCategories();saveExt();
...
// Alpha 0.6.8: simplify visible diary status. Existing active entries now count immediately.
Object.values(ext.diary||{}).forEach(items=>(items||[]).forEach(entry=>{if(entry.status!=="skipped")entry.status="eaten";}));
saveExt();
})();
