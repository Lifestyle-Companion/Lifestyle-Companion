...
function ensureSchemas(){
  const main=read(MAIN_KEY,{});main.version=APP.version||"0.6.9";main.personal||={};main.personal.surname??="";main.personal.homeTimeZone||=deviceTZ();main.personal.activeTimeZone||=main.personal.homeTimeZone;main.personal.timeZoneBehaviour||="ask";main.analytics||={consent:false};main.developer||={founderEnabled:false};main.trial||={};
  ...
  write(MAIN_KEY,main);
  const ext=read(EXT_KEY,{});ext.version=APP.version||"0.6.9";ext.fluidTargets||={};ext.ui||={};write(EXT_KEY,ext);
